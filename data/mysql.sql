...
-- Records of menus
-- ----------------------------
INSERT INTO `menus` VALUES (1, '欢迎页',   NULL, NULL, NULL, '{"priority": 10, "namespace": "Power\\\\Controllers", "controller": "Index"}', '[]', 'fa fa-child', NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (2, '系统管理', NULL, NULL, NULL, NULL, '[]', 'fa fa-wrench', NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (3, '用户管理', NULL, NULL, NULL, '{"priority": 10, "namespace": "Power\\\\Controllers", "controller": "Users"}', '[]', 'fa fa-user', 2, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (4, '角色管理', NULL, NULL, NULL, '{"priority": 10, "namespace": "Power\\\\Controllers", "controller": "Roles"}', '[]', 'fa fa-users', 2, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (5, '菜单管理', NULL, NULL, NULL, '{"namespace": "Power\\\\Controllers", "controller": "Menus"}', '[]', 'fa fa-legal', 2, 6, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (6, '配置管理', NULL, NULL, NULL, '{"namespace": "Power\\\\Controllers", "controller": "Configs"}', '[]', 'fa fa-cubes', 2, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (8, '插件管理', NULL, NULL, '/admin/plugins', '{"namespace": "Power\\\\Controllers", "controller": "plugins"}', '[]', 'fa fa-gears', 2, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (9, '系统日志', NULL, NULL, '/admin/logs', '{"namespace": "Power\\\\Controllers", "controller": "logs"}', '[]', 'fa fa-wpforms', 2, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menus` VALUES (26, 'API测试',NULL, NULL, '/GraphApi', '{"namespace": "plugins\\\\GraphQL\\\\Controllers", "controller": "graph-ql"}', '[]', '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
